...
public class DownloadIntentService extends IntentService {
    ...
    protected void onHandleIntent (Intent intent) {
    	...
    	Messenger responseMessenger = (Messenger) intent.getExtras().get(DownloadUtils.MESSENGER_KEY);
    	String localFilePath = DownloadUtils.downloadFile(this, intent.getData());
    	DownloadUtils.sendPath(localFilePath, responseMessenger);
